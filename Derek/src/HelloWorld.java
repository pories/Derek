...
import javax.swing.JOptionPane; // Dialog used for user input
import java.util.*; // Used to generate ranges
...
public class HelloWorld {
	...
	int var1 = 100;
	int v2, v3;// Create multiple variables		 
	// ---- DATA TYPES ----
	...
	// a5[3][4][1]
	String a5[][][] = {{{"000"}, {"100"}, {"200"}, {"300"}},{{"010"}, {"110"}, {"210"}, {"310"}},
	{{"020"}, {"120"}, {"220"}, {"320"}}};
